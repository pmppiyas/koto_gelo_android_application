...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "C:/Users/WIN-11/AppData/Local/pnpm/global/5/.pnpm/typescript@5.9.3/node_modules/typescript/bin/tsc" $args
  } else {
    & "$basedir/node$exe"  "C:/Users/WIN-11/AppData/Local/pnpm/global/5/.pnpm/typescript@5.9.3/node_modules/typescript/bin/tsc" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "C:/Users/WIN-11/AppData/Local/pnpm/global/5/.pnpm/typescript@5.9.3/node_modules/typescript/bin/tsc" $args
  } else {
    & "node$exe"  "C:/Users/WIN-11/AppData/Local/pnpm/global/5/.pnpm/typescript@5.9.3/node_modules/typescript/bin/tsc" $args
  }
  $ret=$LASTEXITCODE
}
